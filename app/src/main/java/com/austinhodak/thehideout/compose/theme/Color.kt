...
val DividerDarkLighter = Color(0x19000000)
...
val itemBlue = Color(0xff222A2F)
val itemGrey = Color(0xff1B1C1C)
val itemRed = Color(0xff311B18)
val itemOrange = Color(0xff201813)
val itemDefault = Color(0xff383A3A)
val itemViolet = Color(0xff261F29)
val itemYellow = Color(0xff313122)
val itemGreen = Color(0xff181F11)
