...
class Drawer(context: Context, attrs: AttributeSet? = null) : MaterialDrawerSliderView(context, attrs) {
    ...
    private val drawerMedical = PrimaryDrawerItem().apply { identifier = 105; nameText = "Medical"; iconRes = R.drawable.icons8_syringe_100; isIconTinted = true; typeface = benderFont }
    ...
    private val drawerSkills = PrimaryDrawerItem().apply { identifier = 111; nameText = "Skills"; iconRes = R.drawable.icons8_development_skill_96; isIconTinted = true; typeface = benderFont }
    private val drawerWeaponMods = PrimaryDrawerItem().apply { identifier = 111; nameText = "Weapon Mods"; iconRes = R.drawable.icons8_assault_rifle_mod_96; isIconTinted = true; typeface = benderFont }
