...
val md_theme_light_primary = Color(0xFFB52524)
...
val md_theme_light_surfaceTint = Color(0xFFB52524)
...
val md_theme_dark_primaryContainer = Color(0xFF92040F)
...
val md_theme_dark_inversePrimary = Color(0xFFB52524)
...
fun ColorScheme.tertiaryColorAtElevation(
    elevation: Dp,
): Color {
    if (elevation == 0.dp) return surface
    val alpha = ((4.5f * ln(elevation.value + 1)) + 2f) / 100f
    return tertiary.copy(alpha = alpha).compositeOver(surface)
}